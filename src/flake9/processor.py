...
class FileProcessor(object):
    ...
    def file_tokens(self):  # type: () -> List[_Token]
        ...
        :raises: flake9.exceptions.InvalidSyntax
        """
    ...
    def should_ignore_file(self):
        # type: () -> bool
        """Check if ``flake9: noqa`` is in the file to be ignored.
        ...
        if not self.options.disable_noqa and any(
            ...
            LOG.warning(
                "Detected `flake9: noqa` on line with code. To ignore an "
