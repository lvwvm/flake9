"""Contains the logic for all of the default options for Flake9."""
import argparse
import functools

from flake9 import defaults
from flake9.main import debug
from flake9.main import vcs
...
def register_preliminary_options(parser):
    ...
    add_argument(
        ...
        "found by Flake9 by default. These files are the last ones read "
    ...
    add_argument(
        ...
        "source. This will cause Flake9 to ignore all other "
        "configuration files.",
    )
...
def register_default_options(option_manager):
    ...
    add_option(
        ...
        " This is useful for editors piping the file contents to flake9."
        " (Default: %(default)s)",
    )
    ...
    add_option(
        ...
        default=False,
        action="store_true",
        help="Print benchmark information about this run of Flake9",
    )
