"""Module containing the application logic for Flake9."""
...
from flake9 import defaults
from flake9 import exceptions
from flake9 import style_guide
from flake9 import utils
from flake9.main import options
from flake9.options import aggregator, config
...
if False:  # `typing.TYPE_CHECKING` was introduced in 3.5.2
    ...
    from flake9.formatting.base import BaseFormatter
...
class Application(object):
    ...
    def __init__(self, program="flake9", version=flake9.__version__):
        ...
        #: The instance of :class:`flake9.options.manager.OptionManager` used
        ...
        #: The instance of :class:`flake9.plugins.manager.Checkers`
        self.check_plugins = None  # type: plugin_manager.Checkers
        # fmt: off
        #: The instance of :class:`flake9.plugins.manager.ReportFormatters`
        ...
        #: The :class:`flake9.style_guide.StyleGuideManager` built from the
        #: user's options
        self.guide = None  # type: style_guide.StyleGuideManager
        #: The :class:`flake9.checker.Manager` that will handle running all of
        ...
        #: flake9 and taking into account ignored errors and lines.
        self.result_count = 0
    ...
    def run_checks(self, files=None):
        ...
        :class:`~flake9.checker.Manger` instance run the checks it is
        managing.
        ...
        try:
            ...
            print("Run flake9 with greater verbosity to see more details")
    ...
    def report_errors(self):
        # type: () -> None
        """Report all the errors found by flake9 3.0.
    ...
    def initialize(self, argv):
        ...
        flake9.configure_logging(prelim_opts.verbose, prelim_opts.output_file)
    ...
    def run(self, argv):
        ...
        entirety of the flake9 application. If it sees a KeyboardInterrupt it
        will forcibly clean up the :class:`~flake9.checker.Manager`.
        """
        try:
            self._run(argv)
            ...
            print("There was a critical error during execution of Flake9:")
            print(exc)
            LOG.exception(exc)
            self.catastrophic_failure = True
