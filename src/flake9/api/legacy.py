"""Module containing shims around Flake9 2.x behaviour.

Previously, users would import :func:`get_style_guide` from ``flake9.engine``.
...
class StyleGuide(object):
    """Public facing object that mimic's Flake9 2.0's StyleGuide.

    .. note::

        There are important changes in how this object behaves compared to
        the StyleGuide object provided in Flake9 2.x.
    ...
    def check_files(self, paths=None):
        ...
        :returns:
            Object that mimic's Flake9 2.0's Reporter class.
        :rtype:
            flake9.api.legacy.Report
        """
...
class Report(object):
    """Public facing object that mimic's Flake9 2.0's API.

    .. note::

        There are important changes in how this object behaves compared to
        the object provided in Flake9 2.x.
