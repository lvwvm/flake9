"""Implementation of the StyleGuide used by Flake9."""
import argparse
import collections
import contextlib
import copy
...
from flake9._compat import lru_cache
from flake9.formatting import base as base_formatter
...
class Violation(_Violation):
    """Class representing a violation reported by Flake9."""
    ...
    def is_in(self, diff):
        ...
        # flake9.utils.parse_unified_diff). In that case ranges below
...
class StyleGuideManager(object):
    ...
    def populate_style_guides_with(self, options):
        ...
        :rtype:
            :class:`~flake9.style_guide.StyleGuide`
        """
...
class StyleGuide(object):
    """Manage a Flake9 user's style guide."""
