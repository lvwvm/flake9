"""Statistic collection logic for Flake9."""
import collections
...
class Statistics(object):
    """Manager of aggregated statistics for a run of Flake9."""
    ...
    def statistics_for(self, prefix, filename=None):
        ...
        .. code-block:: python
            ...
            >>> stats.statistics_for('E12',
                                     filename='src/flake9/statistics.py')
            <generator ...>
...
class Key(collections.namedtuple("Key", ["filename", "code"])):
    ...
    def create_from(cls, error):  # type: (Violation) -> Key
        """Create a Key from :class:`flake9.style_guide.Violation`."""
...
class Statistic(object):
    ...
    def create_from(cls, error):  # type: (Violation) -> Statistic
        """Create a Statistic from a :class:`flake9.style_guide.Violation`."""
        return cls(
