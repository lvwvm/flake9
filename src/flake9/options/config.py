"""Config handling logic for Flake9."""
import collections
import configparser
import logging
import os.path
...
class ConfigFileFinder(object):
    ...
    def __init__(
        ...
        :param str program_name:
            Name of the current program (e.g., flake9).
...
class MergedConfigParser(object):
    ...
    def __init__(self, option_manager, config_finder):
        ...
        :param flake9.options.manager.OptionManager option_manager:
            Initialized OptionManager.
        :param flake9.options.config.ConfigFileFinder config_finder:
            Initialized ConfigFileFinder.
        """
        #: Our instance of flake9.options.manager.OptionManager
        ...
        #: :class:`~flake9.options.manager.Option` instances
...
def get_local_plugins(config_finder):
    ...
    :rtype:
        flake9.options.config.LocalPlugins
    """
