...
class Plugin(object):
    ...
    def _load(self):
        ...
        if not callable(self._plugin):
            msg = (
                ...
                " older version of flake9 and might not work with this"
    ...
    def register_options(self, optmanager):
        ...
        :type optmanager:
            flake9.options.manager.OptionManager
        :returns:
            Nothing
        """
...
class PluginManager(object):  # pylint: disable=too-few-public-methods
    ...
    def __init__(self, namespace, local_plugins=None):
        ...
        :param str namespace:
            Namespace of the plugins to manage, e.g., 'flake9.extension'.
    ...
    def _load_entrypoint_plugins(self):
        ...
        for entry_point in sorted(frozenset(eps)):
            if entry_point.name == "per-file-ignores":
                LOG.warning(
                    "flake9-per-file-ignores plugin is incompatible with "
                    "flake9>=3.7 (which implements per-file-ignores itself)."
                )
                continue
    ...
    def map(self, func, *args, **kwargs):
        ...
        :param collections.Callable func:
            ...
            passed is a :class:`~flake9.plugins.manager.Plugin`.
        :param args:
