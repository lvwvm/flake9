"""Plugin built-in to Flake9 to treat pyflakes as a plugin."""
# -*- coding: utf-8 -*-
from __future__ import absolute_import

try:
    # The 'demandimport' breaks pyflakes and flake9.plugins.pyflakes
...
class FlakesChecker(pyflakes.checker.Checker):
    """Subclass the Pyflakes checker to conform with the flake9 API."""
    ...
    def add_options(cls, parser):
        """Register options for PyFlakes on the Flake9 OptionManager."""
        parser.add_option(
            "--builtins",
    ...
    def parse_options(cls, options):
        """Parse option values from Flake9's OptionManager."""
        if options.builtins:
    ...
    def run(self):
        ...
        for message in self.messages:
            ...
            yield (
                ...
                col,
                "{} {}".format(
                    FLAKE9_PYFLAKES_CODES.get(type(message).__name__, "F999"),
