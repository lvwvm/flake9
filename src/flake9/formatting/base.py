...
if False:  # `typing.TYPE_CHECKING` was introduced in 3.5.2
    from flake9.statistics import Statistics
...
class BaseFormatter(object):
    ...
    def beginning(self, filename):  # type: (str) -> None
        ...
        :param str filename:
            The name of the file that Flake9 is beginning to report results
            from.
        """
    ...
    def finished(self, filename):  # type: (str) -> None
        ...
        :param str filename:
            The name of the file that Flake9 has finished reporting results
            from.
        """
    ...
    def handle(self, error):  # type: (Violation) -> None
        """Handle an error reported by Flake9.
        ...
        :param error:
            ...
            :class:`~flake9.style_guide.Violation`.
        :type error:
            flake9.style_guide.Violation
        """
